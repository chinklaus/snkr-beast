...
export const aboutPageID = `*[_type=="page" && slug.current == 'about-us'][0]._id`;
export const contactUsID = `*[_type=="page" && slug.current == 'contact-us'][0]._id`;
...
export const site = `
  "site": {
    ...
    "footer": *[_type == "footerSettings"][0]{
      ...
      "siteCopyright": *[_type == "generalSettings"][0].siteCopyright
    },
